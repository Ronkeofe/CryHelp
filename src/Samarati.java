...
public class Samarati
{
    ...
    public static String[][] kanon(int kAnon, int maxSup, QuasiID... list)
    {
        ...
        while (lowestHeight < maxHeight)
        {
           ...
           // System.out.println("currentLatticeLevel is " + currentLatticeLevel);
            
            solutionSet = combos.getCombosAt(currentLatticeLevel);
            //System.out.println("solun set is " + combos.getCombosAt(currentLatticeLevel));

            // Iterate through all solutions
            for ( int currentSol = 0; currentSol < solutionSet.length; currentSol++ )
            {
               //System.out.println("solun set is " + solutionSet.length);
                ...
                for ( int currentQuasi = 0; currentQuasi < list.length; currentQuasi++ )
                {
                   ...
                   // System.out.println("solun set is " + solutionSet[currentSol][currentQuasi]);
                }
...
//        String[] data =  genTable.getAttributesToGeneralize(bestSolution);
//        for(String d:data){
//        
//            System.out.println("Here are the attributes "+ d);
//        }
